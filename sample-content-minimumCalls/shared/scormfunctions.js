...
function findAPI(win)
{
           ...
           (win.parent != win) )
   {
      ...
      if (findAPITries > 7)
      {
         console.log("scormFunctions.findAPI >> Error finding API -- too deeply nested.");
         return null;
      }
...
function getAPI()
{
   ...
   if (theAPI == null)
   {
      ...
      console.log("scormFunctions.findAPI >> Unable to find an API adapter");
   }
   return theAPI;
}
...
function ScormProcessInitialize(){
    ...
    if (API == null){
        console.log("scormFunctions.ScormProcessInitialize >> ERROR - Could not establish a connection with the LMS.\n\nYour results may not be recorded.");
        return;
    }
    ...
    if (result == SCORM_FALSE){
        ...
        console.log("scormFunctions.ScormProcessInitialize >> Error - Could not initialize communication with the LMS.\n\nYour results may not be recorded.\n\n" + errorDescription);
        return;
    }
    
    console.log("scormFunctions.ScormProcessInitialize >> completed with result=["+result+"]");
    initialized = true;
}
...
function ScormProcessFinish(){
    ...
    if (result == SCORM_FALSE){
        ...
        console.log("scormFunctions.ScormProcessFinish >> Error - Could not terminate communication with the LMS.\n\nYour results may not be recorded.\n\n" + errorDescription);
        return;
    }
}
